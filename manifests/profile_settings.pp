# == Class: common::profile_settings
#
# This class takes various common security-related settings and
...
class common::profile_settings (
  ...
  file { '/etc/profile.d/simp.sh':
    ...
    mode    => '0644',
    seltype => 'bin_t',
    content => template('common/etc/profile.d/simp.sh.erb')
  }
  ...
  file { '/etc/profile.d/simp.csh':
    ...
    mode    => '0644',
    seltype => 'bin_t',
    content => template('common/etc/profile.d/simp.csh.erb')
  }
